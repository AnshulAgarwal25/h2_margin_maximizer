...
entry_constraints_dummy = {
    'Marketing': {'Demand - H2O2 (TPD)': {'min': 80, 'max': 150},
                  'Demand - Flaker (TPD)': {'min': 400, 'max': 450}},

    'Finance': {'Pipeline': 20.11, 'Bank': 20.11, 'H2O2': 25.52, 'Flaker': 15.3, 'Boiler': 4.4, 'HCl': 0, 'Vent': 0},
    ...
    'H2 Plant': {'Pipeline Compressor Capacity (NM3/hr)': {'min': 0, 'max': 12000},
                 ...
                 'Header Pressure Threshold (kgf/cm2)': {'min': 55, 'max': 135},
                 'Changeover time from pipeline to bank (hrs)': 0.1},

    'H2O2 Plant': {'H2O2 Production Capacity (TPD)': {'min': 0, 'max': 150},
    ...
    'Flaker Plant': {'Flaker-1 Load Capacity (TPD)': {'min': 70, 'max': 100},
                     ...
                     'Flaker - Changeover time (NG to mix) (hrs)': 2, 'Flaker - H2 load inc/dec time (hrs)': 1
                     },
